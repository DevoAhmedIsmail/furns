...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute transition-opacity rounded-sm right-4 top-6 opacity-70 text-mainColor hover:opacity-100 focus:outline-none disabled:pointer-events-none">
        <X className="w-6 h-6" />
